...
def choice_char_class(char_name: str) -> Character:
    ...
    game_classes: dict(str, Character) = {'warrior': Warrior, 'mage': Mage, 'healer': Healer}
...
def start_training(character: Character) -> str:
    """
    Принимает объект класса Character
    Возвращает сообщения о результатах тренировки.
    """
    #Добавлен словарь, в котором соотносится ввод пользователя и выполняемые действия.
    ...
    while selected_command != 'skip':
        selected_command = input('Введи команду: ')
        if selected_command in commands:
            print(commands[selected_command])
